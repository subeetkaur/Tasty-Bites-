...
<div id='cssmenu'>
                    <ul>
                        ...
                        <li><a href="restauranthome.jsp"><span>Home</span></a></li>
                        ...
                        <li class='has-sub'><a href='#'><span>My Profile</span></a>
                            ...
                            <ul>
                                ...
                                <li><a href="manage_food_category.jsp"><span>Manage Food Category</span></a></li>
                                <li><a href="edit_restaurant_info.jsp"><span>Edit my Info</span></a></li>
                                <li><a href="edit_restaurant_pic.jsp"><span>Change my Photo</span></a></li>
                                <li><a href="restaurant_gallery.jsp"><span>Manage my gallery</span></a></li>
                                <li><a href="change_rest_password1.jsp"><span>Change Password</span></a></li>
                                 <li><a href="logout.jsp"><span>Logout</span></a></li>
                            </ul>
                        </li>
                        <li class='has-sub'><a href='#'><span>Menu Category</span></a>

                            <ul>
                                <li><a href="restaurant_menu_category.jsp"><span>Add menu category</span></a></li>
                                <li class='last'><a href="restaurant_category_view.jsp"><span>View menu category</span></a></li>
                            </ul>
                        </li>
                        <li class='has-sub'><a href='#'><span>Sub Menu</span></a>

                            <ul>
                                <li><a href="restaurant_submenu_category.jsp"><span>Add sub menu</span></a></li>
                                <li class='last'><a href="restaurant_submenu_category_view.jsp"><span>View Submenu</span></a></li>
                            </ul>
                        </li>
                        <li class='has-sub'><a href='#'><span>Food Item</span></a>

                            <ul>
                                <li><a href="add_menu.jsp"><span>Add Food Item</span></a></li>
                                <li class='last'><a href="view_menu.jsp"><span>View Food Items</span></a></li>
                            </ul>
                        </li>
